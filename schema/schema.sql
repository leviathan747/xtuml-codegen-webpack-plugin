...
CREATE ROP REF_ID R1650 FROM MC D_TERM (Deployment_ID) TO 1 D_DEPL (Deployment_ID);
CREATE ROP REF_ID R1651 FROM MC D_TSVC (Term_ID) TO 1 D_TERM (Term_ID);
CREATE ROP REF_ID R1652 FROM MC D_TSPARM (Svc_ID) TO 1 D_TSVC (Svc_ID);
...
CREATE ROP REF_ID R1655 FROM MC S_DIM (TSParm_ID) TO 1C D_TSPARM (TSParm_ID);
CREATE ROP REF_ID R1656 FROM MC D_TSVC (DT_ID) TO 1 S_DT (DT_ID);
CREATE ROP REF_ID R1657 FROM MC S_DIM (Svc_ID) TO 1C D_TSVC (Svc_ID);
...
CREATE ROP REF_ID R2968 FROM MC I_RCH (Execution_Engine_ID) PHRASE 'is interface requirer of' TO 1 I_EXE (Execution_Engine_ID) PHRASE 'is interface provider to';
CREATE ROP REF_ID R2968 FROM MC I_RCH (other_Execution_Engine_ID) PHRASE 'is interface provider to' TO 1 I_EXE (Execution_Engine_ID) PHRASE 'is interface requirer of';
...
CREATE ROP REF_ID R3000 FROM MC L_LCL (Block_ID, Stack_Frame_ID) TO 1 I_BSF (Block_ID, Stack_Frame_ID);
...
CREATE ROP REF_ID R3312 FROM MC I_AVL (Derived_RuntimeValue_ID) TO 1C RV_RVL (RuntimeValue_ID);
...
CREATE ROP REF_ID R835 FROM MC V_LOC (Var_ID) TO 1C V_VAR (Var_ID);
...
CREATE ROP REF_ID R9500 FROM 1 SQU_Q (Engine_Id) TO 1C SEN_E (Id);
CREATE ROP REF_ID R9501 FROM 1C SEN_ALE (Id) TO 1 SEN_E (Id);
CREATE ROP REF_ID R9501 FROM 1C SEN_DCE (Id) TO 1 SEN_E (Id);
CREATE ROP REF_ID R9501 FROM 1C SEN_DE (Id) TO 1 SEN_E (Id);
CREATE ROP REF_ID R9501 FROM 1C SEN_RE (Id) TO 1 SEN_E (Id);
CREATE ROP REF_ID R9502 FROM MC SP_SP (Engine_Id) TO 1 SEN_E (Id);
CREATE ROP REF_ID R9503 FROM MC SR_SR (Engine_Id) TO 1 SEN_E (Id);
...
CREATE ROP REF_ID R9600 FROM 1C SQU_A (Id) TO 1 SQU_Q (Id);
CREATE ROP REF_ID R9600 FROM 1C SQU_D (Id) TO 1 SQU_Q (Id);
CREATE ROP REF_ID R9600 FROM 1C SQU_DE (Id) TO 1 SQU_Q (Id);
CREATE ROP REF_ID R9600 FROM 1C SQU_R (Id) TO 1 SQU_Q (Id);
CREATE ROP REF_ID R9700 FROM 1 SP_SE (Participant_Id) TO 1 SP_SP (Id);
CREATE ROP REF_ID R9702 FROM 1C SP_ALS (Id) TO 1 SP_SE (Id);
CREATE ROP REF_ID R9702 FROM 1C SP_DS (Id) TO 1 SP_SE (Id);
CREATE ROP REF_ID R9702 FROM 1C SP_NS (Id) TO 1 SP_SE (Id);
CREATE ROP REF_ID R9800 FROM MC SR_M (Result_Id) TO 1 SR_SR (Id);
CREATE ROP REF_ID R9801 FROM 1C SR_CM (Id) TO 1 SR_M (Id);
CREATE ROP REF_ID R9801 FROM 1C SR_NM (Id) TO 1 SR_M (Id);
CREATE ROP REF_ID R9802 FROM 1C SR_SR (MatchedParticipant_Id) TO 1 SP_SP (Id);
